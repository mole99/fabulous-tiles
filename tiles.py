...
tile_sizes = {
    "classic": {
        "sky130*": {
            ...
            "MACC"          : (210.80+0.46*20, 223.04*2),
            "S_term_MACC"   : (210.80+0.46*20,  57.12),
            "N_term_MACC"   : (210.80+0.46*20,  57.12),

            "*_TT_IF2"      : ( 56.12, 223.04*2),
        ...
        "gf180mcu*": {
            ...
            "*_TT_IF2"      : ( 77.84+40*0.56, 302.96*2),
            "*_TT_IF"       : ( 77.84+40*0.56, 302.96),
