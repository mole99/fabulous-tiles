    ...
    "classic": {
        ...
        "gf180mcu*": {
            ...
            "*": {
                ...
                "NE*"       : ( 86.24,  86.24),
                "NW*"       : ( 86.24 + 20 * 0.56,  86.24),
                "SE*"       : ( 86.24,  86.24),
                "SW*"       : ( 86.24 + 20 * 0.56,  86.24),
                
                "N*"        : (302.96,  86.24),
                "E*"        : ( 86.24, 302.96),
                "S*"        : (302.96,  86.24),
                "W*"        : ( 86.24 + 20 * 0.56, 302.96),
            },
        },
        "ihp-sg13*": {
            "*": {
                ...
                "S_term_RegFile": (219.84+0.48*96,  60.48),
                "N_term_RegFile": (219.84+0.48*96,  60.48),

                "MACC"          : (219.84, 219.24*2),
                "S_term_MACC"   : (219.84,  60.48),
                "N_term_MACC"   : (219.84,  60.48),
